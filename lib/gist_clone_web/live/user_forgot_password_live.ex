defmodule GistCloneWeb.UserForgotPasswordLive do
  ...
  def render(assigns) do
    ~H"""
    <div class="dm-gradient flex flex-col items-center justify-center">
    ...
    <div class="mx-auto max-w-sm">
      ...
      <p class="text-center text-l font-brand font-bold text-white mt-4">
        <.link href={~p"/users/register"} class="text-dmLavender-dark hover:underline">
          Register
        </.link>
        | <.link href={~p"/users/log_in"} class="text-dmLavender-dark hover:underline">Log in</.link>
      </p>
    </div>
    """
  end
